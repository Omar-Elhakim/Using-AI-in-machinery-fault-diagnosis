...
class PreLoader:
    ...
    def __init__(self, type):
        self.type = type
        if self.type == "vhr":
            self.df = pd.read_csv(r"D:\ai-vibration-diagnostics\datasets\vhr\metadata.csv")
        
        elif self.type == "vlr":
            self.df = pd.read_csv(r"D:\ai-vibration-diagnostics\datasets\vlr\metadata.csv")
            
        elif self.type == "both":
            df_hr = pd.read_csv(r"D:\ai-vibration-diagnostics\datasets\vhr\metadata.csv")
            df_lr = pd.read_csv(r"D:\ai-vibration-diagnostics\datasets\vlr\metadata.csv")
