...
class PreLoader:
    ...
    parent_folder = r"/home/omar/drive/ai-vibration-diagnostics/datasets/"

    def __init__(self, type):
        self.type = type
        if self.type == "vhr":
            self.df = pd.read_csv(
                r"/home/omar/drive/ai-vibration-diagnostics/datasets/vhr/metadata.csv"
            )

        elif self.type == "vlr":
            self.df = pd.read_csv(
                r"/home/omar/drive/ai-vibration-diagnostics/datasets/vlr/metadata.csv"
            )
